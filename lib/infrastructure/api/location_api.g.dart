...
class _LocationApi implements LocationApi {
  ...
  Future<ListResponse<LocationDto>> getLocations({
    ...
    final _options = _setStreamType<ListResponse<LocationDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ListResponse<LocationDto> _value;
    try {
      _value = ListResponse<LocationDto>.fromJson(
        _result.data!,
  ...
  @override
  Future<List<LocationDto>> getMultipleLocations({required String ids}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<LocationDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
